...
namespace Caramel.Client
{
    ...
    {
        public static readonly object GrpLocker = new object();

        private static readonly Dictionary<IJointType, string> JointDictionary = new Dictionary<IJointType, string>()
        {
        ...
        private readonly Dictionary<string, SCNNode> _joints = new Dictionary<string, SCNNode>();
        ...
        {
            if (!(anchor is ARBodyAnchor bodyAnchor)) return;
